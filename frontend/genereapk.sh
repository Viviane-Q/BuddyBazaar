...
npm install --legacy-peer-deps # Installe les dépendances du projet
...
cp ./app/build/outputs/apk/release/app-release.apk ../public/buddy-bazaar.apk # Déplace l'application générée dans /public 
exit 0
